...
public class CieDroneHQ extends IntegratedAgent{
    ...
    private ACLMessage droneDLXSender, droneDLXReceiver;
    ...
    private void market(){
        ...
        // Enviamos mensaje a droneDLX con el dinero restante
        /*
        droneDLXSender.addReceiver(new AID("CieDroneDLX", AID.ISLOCALNAME));
        droneDLXSender.setPerformative(ACLMessage.INFORM);
        content = this.getExtraCoinsMessage();
        droneDLXSender.setContent(content.toString());
        this.send(droneDLXSender);
        */
    ...
    private void readSensors(){
        ...
        if(worldManagerReceiver.getPerformative() != ACLMessage.INFORM){
            ...
            System.out.println(worldManagerReceiver.getContent());
        }
